...
IF NOT EXISTS (SELECT 1 
    ...
    VALUES ('0', 'SIN DOCUMENTO', '<Ninguno>', '0',  var_f_aud, var_b_aud, var_c_aud_uid, var_c_aud_uidred, var_c_aud_pc, var_c_aud_ip, var_c_aud_mcaddr);
...
IF NOT EXISTS (SELECT 1 
    ...
    INSERT INTO serviciosexternos.mae_tipo_documento(b_tipo_documento, x_tipo_documento, x_abreviatura, l_activo, f_aud, b_aud, c_aud_uid, c_aud_uidred, c_aud_pc, c_aud_ip, c_aud_mcaddr) 
    VALUES ('5', 'PASAPORTE', 'P.S', '0',var_f_aud, var_b_aud, var_c_aud_uid, var_c_aud_uidred, var_c_aud_pc, var_c_aud_ip, var_c_aud_mcaddr);
...
IF NOT EXISTS (SELECT 1 
    ...
    INSERT INTO serviciosexternos.mae_tipo_documento(b_tipo_documento, x_tipo_documento, x_abreviatura, l_activo, f_aud, b_aud, c_aud_uid, c_aud_uidred, c_aud_pc, c_aud_ip, c_aud_mcaddr) 
    VALUES ('6', 'CARNET DE EXTRANJERIA', 'C.E', '0' ,var_f_aud, var_b_aud, var_c_aud_uid, var_c_aud_uidred, var_c_aud_pc, var_c_aud_ip, var_c_aud_mcaddr);
...
IF NOT EXISTS (SELECT 1 
    ...
    INSERT INTO serviciosexternos.mae_tipo_documento(b_tipo_documento, x_tipo_documento, x_abreviatura, l_activo, f_aud, b_aud, c_aud_uid, c_aud_uidred, c_aud_pc, c_aud_ip, c_aud_mcaddr) 
    VALUES ('H', 'CARNET DE TRABAJO', 'C.T.', '0', var_f_aud, var_b_aud, var_c_aud_uid, var_c_aud_uidred, var_c_aud_pc, var_c_aud_ip, var_c_aud_mcaddr);
