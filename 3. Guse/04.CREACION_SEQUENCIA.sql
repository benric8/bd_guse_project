...
CREATE SEQUENCE IF NOT EXISTS serviciosexternos.useq_mov_consumo_cuota START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS serviciosexternos.useq_aud_mov_consumo_cuota START WITH 1 INCREMENT BY 1;