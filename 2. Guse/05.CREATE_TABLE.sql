...
CREATE TABLE IF NOT EXISTS serviciosexternos.mov_consumo_cuota (
  ...
  c_aud_ip VARCHAR(40),
  c_aud_mcaddr VARCHAR(17),
  CONSTRAINT pk_mae_consumo_cuota PRIMARY KEY (n_consumo_cuota),
  CONSTRAINT fk_mae_consumo_cuota_01 FOREIGN KEY (n_cliente) REFERENCES serviciosexternos.mae_cliente (n_cliente)
) TABLESPACE "TBS_SERVICIOS_EXTERNOS";
